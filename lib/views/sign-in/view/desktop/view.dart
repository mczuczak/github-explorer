...
class SignInDesktopView extends StatefulWidget {
  const SignInDesktopView({Key? key, required this.controller})
      : super(key: key);
...
class _SignInDesktopViewState extends BaseViewStatefulState<SignInDesktopView> {
  @override
  Widget build(BuildContext context) {
    return DefaultDesktopScaffold(
